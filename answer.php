...
<head>
  <meta charset="utf-8" />
  <meta name="description" content="Division, with PHP" />
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Division, with PHP</span>
      </div>
    </header>
    <main class="mdl-layout__content">
      <div class="right-image">
        <img src="./images/girl-holding-division-symbol-vector-illustration-69507387.webp" alt="Division image" width="500" />
      </div>
